...
| OpenTelemetry collector | Down | Spans are dropped silently by the SDK. trace_events / agent_traces are still persisted to PostgreSQL because the custom trace viewer is independent of the OTel pipeline. | (No user-visible effect.) |
